<script lang="ts">
	...
	$: userDefersToEntry = $currentUserEntry
...
<div
	class="fixed bottom-0 left-0 right-0 p-4 bg-black/10 dark:bg-white !bg-opacity-10 backdrop-blur-[50px]"
>
			...
			<div class="flex flex-row gap-2">
				...
				<div class="flex flex-col items-start">
					<span class="font-medium"
						>Do you consider this version to be better than yours for <i>{event.dTag}</i>?</span
					>
